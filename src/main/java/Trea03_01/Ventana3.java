...
public class Ventana3 extends JFrame{
    ...
    public void iniciarJButtons() {
        ...
        this.jPanelList.get(2).add(this.jButtonList.get(1));
        this.jPanelList.get(3).add(this.jButtonList.get(2));
        this.jPanelList.get(4).add(this.jButtonList.get(3));
        this.jPanelList.get(5).add(this.jButtonList.get(4));
