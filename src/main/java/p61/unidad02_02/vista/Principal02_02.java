...
public class Principal02_02 {
    ...
    public static void main(String[] args) {
       ...
       var luis= new Estudiante("0103667723", "Luis Antonio");
        ...
        var galindez = new Jugador(40, "Hernán Galindez", 80, 175, LocalDate.of(1998, 02, 01));
        var galindezNuevo = new Jugador(40, "Hernán Galindez", 80, 175, LocalDate.of(1998, 02, 01));
        var perro = new Estudiante("05789634587", "aedjbeufiewcf");

        var jugadorDB = new JugadorServicio();
