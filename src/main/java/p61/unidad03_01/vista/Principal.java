...
public class Principal {
    ...
    public static void main(String[] args) {
        ...
        ventana0301a.setTitle("ventana 03_01a");
        ventana0301a.setSize(1100, 600);
        ...
        ventana0301b.setTitle("ventana 03_01b");
        ventana0301b.setSize(1000, 600);
        ventana0301b.setVisible(true);
        ventana0301b.setLocation(300, 200);
        ventana0301b.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);

        var ventana0301c = new JFrame();
        ventana0301c.setTitle("ventana 03_01c");
        ventana0301c.setSize(900, 600);
        ventana0301c.setVisible(true);
        ventana0301c.setLocation(400, 300);
        ventana0301c.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);

        var ventana0301d = new JFrame();
        ventana0301d.setTitle("ventana 03_01d");
